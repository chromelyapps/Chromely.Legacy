This is legacy Chromely and not actively supported. For active cross-platform Chromely see - [.NET/.NET Core 3/.NET 5/Win/Linux/MacOS supported Chromely](https://github.com/chromelyapps/Chromely).
---
...
1. .NET/Javascript integration ([CefSharp](https://github.com/cefsharp/CefSharp))  -  more info @ [Expose .NET class to JavaScript](https://github.com/chromelyapps/Chromely.Legacy/wiki/Expose-.NET-class-to-JavaScript).
2. Generic Message Routing ([Xilium.CefGlue](https://bitbucket.org/xilium/xilium.cefglue/wiki/Home)) - more info @ [Generic Message Routing](https://github.com/chromelyapps/Chromely.Legacy/wiki/Generic-Message-Routing).
3. Ajax HTTP/XHR ([Xilium.CefGlue](https://bitbucket.org/xilium/xilium.cefglue/wiki/Home), [CefSharp](https://github.com/cefsharp/CefSharp)) -  more info @ [Custom Scheme Handling](https://github.com/chromelyapps/Chromely.Legacy/wiki/Custom-Scheme-Handling).
 4. Real-time with Websocket (ws) ([Xilium.CefGlue](https://bitbucket.org/xilium/xilium.cefglue/wiki/Home)) -   more info @ [Real-time with Websocket](https://github.com/chromelyapps/Chromely.Legacy/wiki/Real-time-with-Websocket).
...
For more info/documentation, please check [Chromely wiki](https://github.com/chromelyapps/Chromely.Legacy/wiki). 
...
[![Chromely + Angular](https://img.shields.io/badge/Chromely%20Apps-Built%20with%20Angular%202%2B-green.svg)](https://github.com/chromelyapps/Chromely.Legacy/wiki/Chromely-Apps)
<br>[![Chromely + React](https://img.shields.io/badge/Chromely%20Apps-Built%20with%20React-green.svg)](https://github.com/chromelyapps/Chromely.Legacy/wiki/Chromely-Apps)
...
**Notes on Upgrade to CefGlue version 70 and CefSharp version 71 (Chromely v4)** - Please [see](https://github.com/chromelyapps/Chromely.Legacy/wiki/Upgrade-to-CefGlue-v70-and-CefSharp-v71).
...
````
 - [CefGlue Usage Readme](https://github.com/chromelyapps/Chromely.Legacy/tree/master/Demos/regular-chromely/Chromely.CefGlue.Winapi.Demo/README.md) 
 - [CefSharp Usage Readme](https://github.com/chromelyapps/Chromely.Legacy/tree/master/Demos/regular-chromely/Chromely.CefSharp.Winapi.Demo/README.md)

#### Run Starter Template (Using dotnet core cli). For more info, please see - [dotnet cli demo template install](https://github.com/chromelyapps/Chromely.Legacy/wiki/dotnet-cli-Starter-Template)
...
### Chromely Demos 
For more info on demos - [Demos](https://github.com/chromelyapps/Chromely.Legacy/wiki/Demos)
...
Contributing
---
Contributions are always welcome, via PRs, issues raised, or any other means. To become a dedicated contributor, please [contact the Chromely team](https://github.com/orgs/chromelyapps/people) or [raise an issue](https://github.com/chromelyapps/Chromely.Legacy/issues) mentioning your intent.

License
---
Chromely is MIT licensed. For dependency licenses [please see](https://github.com/chromelyapps/Chromely.Legacy/blob/master/LICENSE.md).
